...
<body>
    <div class="shell">
        <aside class="sidebar">
            ...
            <nav>
                <a class="nav-link {{ request()->routeIs('dashboard.categories.*') ? 'active' : '' }}" href="{{ route('dashboard.categories.index') }}">التصنيفات</a>
            </nav>
        </aside>
        ...
        <main class="main">
            <header class="topbar">
                ...
                <div class="actions">@yield('page-actions')</div>
            </header>
