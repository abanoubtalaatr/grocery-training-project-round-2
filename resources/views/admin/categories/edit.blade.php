...
<x-admin.layout>
    <div class="mb-4">
        ...
        <h1 class="h3 mt-2 mb-1">Edit Category</h1>
                ...
                <div class="card-body p-4">
                    <form method="POST" action="{{ route('admin.categories.update', $category) }}" enctype="multipart/form-data">
                            ...
                            @if($category->image)
                                <div class="mb-2">
                                    <img src="{{ $category->image_url }}" alt="{{ $category->name }}" 
                                        class="rounded-3" style="max-width: 150px; height: auto;">
                                </div>
                            @endif
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('admin.categories.show', $category) }}" class="btn btn-outline-secondary rounded-3">
                                Cancel
                            </a>
                        </div>
                    </form>
