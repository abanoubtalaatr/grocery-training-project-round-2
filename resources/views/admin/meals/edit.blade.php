...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <!-- Header -->
            <div class="mb-4">
                <h1 class="mb-0">Edit Meal: {{ $meal->title }}</h1>
            </div>
                    ...
                    <form method="POST" action="{{ route('admin.meals.update', $meal) }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('title') is-invalid @enderror" 
                                   id="title" name="title" value="{{ old('title', $meal->title) }}" required>
                            @error('title')
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('subcategory_id') is-invalid @enderror" 
                                    ...
                                    @foreach($subcategories as $subcategory)
                                        <option value="{{ $subcategory->id }}" {{ old('subcategory_id', $meal->subcategory_id) == $subcategory->id ? 'selected' : '' }}>
                                            {{ $subcategory->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      id="description" name="description" rows="3">{{ old('description', $meal->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        @if($meal->image_url)
                            <div class="mb-3">
                                ...
                                <div>
                                    <img src="{{ $meal->image_url }}" alt="{{ $meal->title }}" style="max-width: 200px; border-radius: 4px;">
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                ...
                                <input type="number" step="0.01" class="form-control @error('price') is-invalid @enderror" 
                                       id="price" name="price" value="{{ old('price', $meal->price) }}" required>
                                @error('price')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-4">
                                ...
                                <input type="number" step="0.01" class="form-control @error('discount_price') is-invalid @enderror" 
                                       id="discount_price" name="discount_price" value="{{ old('discount_price', $meal->discount_price) }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control @error('offer_title') is-invalid @enderror" 
                                       id="offer_title" name="offer_title" placeholder="e.g. 20% OFF" value="{{ old('offer_title', $meal->offer_title) }}">
                                @error('offer_title')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                ...
                                <input type="number" class="form-control @error('stock_quantity') is-invalid @enderror" 
                                       id="stock_quantity" name="stock_quantity" value="{{ old('stock_quantity', $meal->stock_quantity) }}" required>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" class="form-control @error('sold_count') is-invalid @enderror" 
                                       id="sold_count" name="sold_count" value="{{ old('sold_count', $meal->sold_count) }}">
                                @error('sold_count')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control @error('size') is-invalid @enderror" 
                                       id="size" name="size" placeholder="e.g. 500g" value="{{ old('size', $meal->size) }}">
                                @error('size')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="number" step="0.1" min="0" max="5" class="form-control @error('rating') is-invalid @enderror" 
                                       id="rating" name="rating" value="{{ old('rating', $meal->rating) }}">
                                @error('rating')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control @error('rating_count') is-invalid @enderror" 
                                       id="rating_count" name="rating_count" value="{{ old('rating_count', $meal->rating_count) }}">
                                @error('rating_count')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('brand') is-invalid @enderror" 
                                       id="brand" name="brand" value="{{ old('brand', $meal->brand) }}">
                                @error('brand')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('features') is-invalid @enderror" 
                                       id="features" name="features" placeholder="e.g. Organic, Vegan" value="{{ old('features', $meal->features) }}">
                                @error('features')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('includes') is-invalid @enderror" 
                                      id="includes" name="includes" rows="2">{{ old('includes', $meal->includes) }}</textarea>
                            @error('includes')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('how_to_use') is-invalid @enderror" 
                                      id="how_to_use" name="how_to_use" rows="2">{{ old('how_to_use', $meal->how_to_use) }}</textarea>
                            @error('how_to_use')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control @error('expiry_date') is-invalid @enderror" 
                                       id="expiry_date" name="expiry_date" value="{{ old('expiry_date', $meal->expiry_date?->format('Y-m-d')) }}">
                                @error('expiry_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control @error('available_date') is-invalid @enderror" 
                                       id="available_date" name="available_date" value="{{ old('available_date', $meal->available_date?->format('Y-m-d')) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="is_featured" name="is_featured" value="1" 
                                       {{ old('is_featured', $meal->is_featured) ? 'checked' : '' }}>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="is_hot" name="is_hot" value="1" 
                                       {{ old('is_hot', $meal->is_hot) ? 'checked' : '' }}>
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="{{ route('admin.meals.show', $meal) }}" class="btn btn-outline-secondary">
                                <i class="bi bi-arrow-left"></i> Back
                            </a>
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-check-lg"></i> Update Meal
                            </button>
                        </div>
                    </form>
                </div>
    ...
    document.getElementById('category_id').addEventListener('change', function() {
        ...
        if (categoryId) {
            fetch(`/admin/categories/${categoryId}/subcategories`)
                .then(res => res.json())
                .then(data => {
                    const currentSubcategoryId = '{{ $meal->subcategory_id }}';
