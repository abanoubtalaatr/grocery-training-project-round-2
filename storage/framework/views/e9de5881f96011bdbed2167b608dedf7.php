...
<div class="field">
    ...
    <input id="name" name="name" value="<?php echo e(old('name', $category->name)); ?>" required>
...
<div class="field">
    ...
    <input id="slug" name="slug" value="<?php echo e(old('slug', $category->slug)); ?>" placeholder="يتم إنشاؤه تلقائيا عند تركه فارغا">
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($category->exists): ?>
    <div class="field">
        <img class="thumb" src="<?php echo e($category->image_url); ?>" alt="<?php echo e($category->name); ?>">
    </div>
...
<div class="grid">
    <div class="field">
        ...
        <input id="sort_order" name="sort_order" type="number" min="0" value="<?php echo e(old('sort_order', $category->sort_order ?? 0)); ?>">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <div class="field">
        ...
        <select id="is_active" name="is_active">
            <option value="1" <?php if(old('is_active', $category->is_active) == 1): echo 'selected'; endif; ?>>نشط</option>
            <option value="0" <?php if(old('is_active', $category->is_active) == 0): echo 'selected'; endif; ?>>غير نشط</option>
        </select>
...
<?php /**PATH E:\Traning\projects\grocery-training-project-round-2\resources\views/dashboard/categories/_form.blade.php ENDPATH**/ ?>