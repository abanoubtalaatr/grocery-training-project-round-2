...
<?php foreach($attributes->onlyProps(['field','labelTag']) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
<?php $attributes = $attributes->exceptProps(['field','labelTag']); ?>
<?php foreach (array_filter((['field','labelTag']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament-forms::components.field-wrapper.index','data' => ['field' => $field,'labelTag' => $labelTag]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?><?php /**PATH /home/mohammed-ouais/project-Huma-volve-Laravel/grocery-training-project-round-2/storage/framework/views/36fedf38ee238133bc6a877ab1353c51.blade.php ENDPATH**/ ?>